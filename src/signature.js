...
const DeclarationApplicant = (props) => {
    return (
        <p className="signatureSection">
            ...
            occupation <strong>{props.data.occupationStatus}</strong> solemnly and sincerely declare that I believe the information I have given on this form is true and correct, and I make this solemn declaration conscientiously believing the same to be true and virtue of the Oaths and Declarations Act 1957.
        </p>
    )
}
